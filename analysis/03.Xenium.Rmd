...
RCTD <- readRDS(file = "/Users/a1233698/Library/CloudStorage/Box-Box/other/ASI_workshop/data/RCTD_results.rds")

# read in cell locations file from Xenium raw data bundle
# gunzip("xenium/raw/cells.csv.gz")

# cell locations from cells.csv file
cells_pos <- read.csv("/Users/a1233698/Downloads/xenium_colon/cells.csv",
...
RCTD_level2 <- readRDS(file = "/Users/a1233698/Library/CloudStorage/Box-Box/other/ASI_workshop/data/RCTD_level2.rds")
...
```{r}
saveRDS(object = se, file = "colon_analysis.rds")
```
