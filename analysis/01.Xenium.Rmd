...
10x Genomics Data: https://www.10xgenomics.com/platforms/visium/product-family/dataset-human-crc

Data backup: https://adelaideuniversity.box.com/s/9sjfijf4acuqx50dmmxu511150kqbyf2

Paper of interest: https://www.nature.com/articles/s41588-025-02193-3
...
#se3 <- readRDS(file = "/PATH/data/se_xenium.rds")
```
...
#saveRDS(object = se, file = "/PATH/se_p5.rds")
```
...
```{r, eval=FALSE}
saveRDS(object = se, file = "/PATH/data/se_xenium.rds")
```
